...
**Kiba** Claude Code का एक **पूर्ण Python पुनर्लेखन** है, **वास्तविक TypeScript स्रोत कोड** पर आधारित।

### ⚠️ महत्वपूर्ण: यह केवल स्रोत कोड नहीं है

**लीक हुए TypeScript स्रोत के विपरीत**, Kiba एक **पूर्ण रूप से कार्यात्मक, चलने योग्य CLI उपकरण** है:
...
```text
>>> नमस्ते!
Assistant: नमस्ते! मैं Kiba हूं, एक Python पुनर्कार्यान्वयन...
...
```bash
kiba              # REPL प्रारंभ करें
kiba login        # API कॉन्फ़िगर करें
kiba --version    # संस्करण जांचें
kiba config       # सेटिंग्स देखें
```
...
कॉन्फ़िगरेशन फ़ाइल `~/.kiba/config.json` में सहेजी जाती है। उदाहरण संरचना:
...
![उदाहरण सत्र](../../assets/kiba-tool-skill-json.png)
...
- **इंटरैक्टिव कॉन्फ़िगरेशन** — `kiba login` आपका मार्गदर्शन करता है
...
**Kiba टीम द्वारा ❤️ से बनाया गया**
